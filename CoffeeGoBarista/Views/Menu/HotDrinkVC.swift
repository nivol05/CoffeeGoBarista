...
class HotDrinkVC: UIViewController, IndicatorInfoProvider, UITableViewDelegate, UITableViewDataSource , NVActivityIndicatorViewable{
    
    
    
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(image: #imageLiteral(resourceName: "hot"))
    }
    ...
    override func viewDidLoad() {
        ...
        products = getProductsForType(type: 12)
