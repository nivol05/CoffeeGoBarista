...
class BottleWatherVC: UIViewController, IndicatorInfoProvider, UITableViewDelegate, UITableViewDataSource, NVActivityIndicatorViewable {
    
    
    
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(image: #imageLiteral(resourceName: "Drinks"))
    }
    ...
    override func viewDidLoad() {
        ...
        products = getProductsForType(type: 9)
