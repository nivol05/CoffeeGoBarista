...
class OtherVC: UIViewController, IndicatorInfoProvider, UITableViewDelegate, UITableViewDataSource, NVActivityIndicatorViewable {
    
    
    
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(image: #imageLiteral(resourceName: "Other"))
    }
    ...
    override func viewDidLoad() {
        ...
        products = getProductsForType(type: 11)
